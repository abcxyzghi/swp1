        ...
        >
          ...
          <CardBody w="100%">
            <Flex w="100%" direction={{ sm: 'column', md: 'row' }}>
              <Flex direction="column" align="center" me={{ md: '16px', lg: '50px' }} mb={{ sm: '12px', md: '0px' }}>
                <CircularProgress size={200} value={68} thickness={6} color="green.400" variant="vision">
                  <CircularProgressLabel>
              ...
              <Grid templateColumns={{ sm: '1fr', md: 'repeat(2, 1fr)' }} gap="24px" w="100%" alignSelf="flex-start">
                <Flex
                  align="center"
                  p="18px"
              ...
              <Flex direction="column">
                ...
                <Flex direction="column">
                  ...
                  <Flex justifyContent="space-between" mt="auto">
                    <Button variant="outlineWhite" minW="110px" h="36px" fontSize="10px" px="1.5rem">
                      VIEW ALL
                    </Button>
                    <AvatarGroup size="xs">
