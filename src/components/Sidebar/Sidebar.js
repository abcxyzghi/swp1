...
function Sidebar(props) {
  ...
  const createLinks = (routes) => {
    ...
    return routes.map((prop, key) => {
      ...
      if (!prop.access || prop.access.includes(role)) {
        return (
              ...
              >
                <Flex>
                  {typeof prop.icon === 'string' ? (
                    ...
                    <IconBox bg="brand.200" color="white" h="30px" w="30px" me="12px" transition={variantChange}>
                      {prop.icon}
                    </IconBox>
                  )}
              ...
              >
                <Flex>
                  {typeof prop.icon === 'string' ? (
                    ...
                    <IconBox bg={inactiveBg} color="brand.200" h="30px" w="30px" me="12px" transition={variantChange}>
                      {prop.icon}
                    </IconBox>
                  )}
...
export function SidebarResponsive(props) {
            ...
            >
              <Flex>
                {typeof prop.icon === 'string' ? (
                  ...
                  <IconBox bg="brand.200" color="white" h="30px" w="30px" me="12px">
                    {prop.icon}
                  </IconBox>
                )}
                <Text color={activeColor} my="auto" fontSize="sm">
            ...
            >
              <Flex>
                {typeof prop.icon === 'string' ? (
                  ...
                  <IconBox bg={inactiveBg} color="brand.200" h="30px" w="30px" me="12px">
                    {prop.icon}
                  </IconBox>
                )}
                <Text color={inactiveColor} my="auto" fontSize="sm">
  ...
  return (
    <Flex display={{ sm: 'flex', xl: 'none' }} ref={mainPanel} alignItems="center">
      <HamburgerIcon color={iconColor} w="18px" h="18px" ref={btnRef} colorScheme="teal" onClick={onOpen} />
      <Drawer
        isOpen={isOpen}
        onClose={onClose}
