// Chakra Icons
import { ArrowBackIcon, BellIcon, SearchIcon } from '@chakra-ui/icons';
// Chakra Imports
import {
  Button,
  Flex,
...
export default function HeaderLinks(props) {
  ...
  const handleLogout = () => {
    ...
    authApi.logout({ token: refreshToken });
    dispatch(logout());
    navigate('/');
  };
  return (
      ...
      {!isLogin ? (
        <Link to="/auth/signin">
          <Button
            ...
            rightIcon={
              document.documentElement.dir ? '' : <ProfileIcon color={navbarIcon} w="22px" h="22px" me="0px" />
            }
        ...
        <Flex alignItems={'center'} justifyContent={'center'}>
          <Button
            ...
            leftIcon={document.documentElement.dir ? <ProfileIcon color={navbarIcon} w="22px" h="22px" me="0px" /> : ''}
          >
            <Text display={{ sm: 'none', md: 'flex' }}>{sub}</Text>
          </Button>
          <Button
            ms="0px"
            px="0px"
            ...
            color={navbarIcon}
            variant="transparent-with-icon"
            rightIcon={document.documentElement.dir ? '' : <BiLogOutCircle />}
            leftIcon={document.documentElement.dir ? <BiLogOutCircle /> : ''}
